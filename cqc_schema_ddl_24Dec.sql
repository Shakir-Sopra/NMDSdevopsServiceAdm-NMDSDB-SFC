...
--
-- Name: CqcLog; Type: TABLE; Schema: cqc; Owner: postgres
--
...
--
-- Name: Establishment; Type: TABLE; Schema: cqc; Owner: sfcadmin
--
...
--
-- Name: EstablishmentCapacity_EstablishmentCapacityID_seq; Type: SEQUENCE; Schema: cqc; Owner: sfcadmin
--
...
--
-- Name: EstablishmentCapacity_EstablishmentCapacityID_seq; Type: SEQUENCE OWNED BY; Schema: cqc; Owner: sfcadmin
--
...
--
-- Name: EstablishmentLocalAuthority_EstablishmentLocalAuthorityID_seq; Type: SEQUENCE; Schema: cqc; Owner: sfcadmin
--
...
--
-- Name: EstablishmentLocalAuthority_EstablishmentLocalAuthorityID_seq; Type: SEQUENCE OWNED BY; Schema: cqc; Owner: sfcadmin
--
...
--
-- Name: Feedback_seq; Type: SEQUENCE; Schema: cqc; Owner: sfcadmin
--
...
ALTER TABLE cqc."Feedback_seq" OWNER TO sfcadmin;

--
-- Name: Feedback; Type: TABLE; Schema: cqc; Owner: sfcadmin
--
...
ALTER TABLE cqc."Feedback" OWNER TO sfcadmin;
...
--
-- Name: Login; Type: TABLE; Schema: cqc; Owner: sfcadmin
--
...
--
-- Name: User; Type: TABLE; Schema: cqc; Owner: sfcadmin
--
...
--
-- Name: location; Type: TABLE; Schema: cqc; Owner: sfcadmin
--
...
--
-- Name: pcodedata; Type: TABLE; Schema: cqc; Owner: sfcadmin
--
...
--
-- Name: services; Type: TABLE; Schema: cqc; Owner: sfcadmin
--
...
--
-- Name: EstablishmentCapacity EstablishmentCapacityID; Type: DEFAULT; Schema: cqc; Owner: sfcadmin
--
...
--
-- Name: EstablishmentLocalAuthority EstablishmentLocalAuthorityID; Type: DEFAULT; Schema: cqc; Owner: sfcadmin
--
...
--
-- Name: EstablishmentCapacity EstablishmentCapacity_pkey1; Type: CONSTRAINT; Schema: cqc; Owner: sfcadmin
--
...
--
-- Name: EstablishmentLocalAuthority EstablishmentLocalAuthorityID_Unq; Type: CONSTRAINT; Schema: cqc; Owner: sfcadmin
--

ALTER TABLE ONLY cqc."EstablishmentLocalAuthority"
    ADD CONSTRAINT "EstablishmentLocalAuthorityID_Unq" UNIQUE ("EstablishmentLocalAuthorityID");


--
-- Name: EstablishmentCapacity EstablishmentServiceCapacity_unq1; Type: CONSTRAINT; Schema: cqc; Owner: sfcadmin
--
...
--
-- Name: EstablishmentLocalAuthority establishmentlocalauthority_pk; Type: CONSTRAINT; Schema: cqc; Owner: sfcadmin
--
...
--
-- Name: Feedback feedback_pk; Type: CONSTRAINT; Schema: cqc; Owner: sfcadmin
--
...
--
-- Name: Feedback feedbackid_unq; Type: CONSTRAINT; Schema: cqc; Owner: sfcadmin
--

ALTER TABLE ONLY cqc."Feedback"
    ADD CONSTRAINT feedbackid_unq UNIQUE ("FeedbackID");
...
--
-- Name: Postcodedata_postcode_Idx; Type: INDEX; Schema: cqc; Owner: sfcadmin
--
...
--
-- Name: EstablishmentCapacity EstablishmentServiceCapacity_Establishment_fk1; Type: FK CONSTRAINT; Schema: cqc; Owner: sfcadmin
--
...
--
-- Name: EstablishmentCapacity EstablishmentServiceCapacity_ServiceCapacity_fk1; Type: FK CONSTRAINT; Schema: cqc; Owner: sfcadmin
--
...
--
-- Name: EstablishmentLocalAuthority establishment_establishmentlocalauthority_fk; Type: FK CONSTRAINT; Schema: cqc; Owner: sfcadmin
--
...
--
-- Name: EstablishmentLocalAuthority localauthrity_establishmentlocalauthority_fk; Type: FK CONSTRAINT; Schema: cqc; Owner: sfcadmin
--
